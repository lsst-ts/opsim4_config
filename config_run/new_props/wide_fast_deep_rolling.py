...
class WideFastDeepRolling(General):
    def setDefaults(self):
        ...
        sel0 = Selection()
        sel0.limit_type = "Dec"
        sel0.minimum_limit = -19.6
        sel0.maximum_limit =  18.0
        sel1 = Selection()
        sel1.limit_type = "Dec"
        sel1.minimum_limit = -78.0
        sel1.maximum_limit = -19.6
        sel2 = Selection()
        sel2.limit_type = "Dec"
        sel2.minimum_limit = -19.6
        sel2.maximum_limit =  18.0
        sel3 = Selection()
        sel3.limit_type = "Dec"
        sel3.minimum_limit = -78.0
        sel3.maximum_limit = -19.6
        sel4 = Selection()
        sel4.limit_type = "Dec"
        sel4.minimum_limit = -19.6
        sel4.maximum_limit =  18.0
        sel5 = Selection()
        sel5.limit_type = "Dec"
        sel5.minimum_limit = -78.0
        sel5.maximum_limit = -19.6
        sel6 = Selection()
        sel6.limit_type = "Dec"
        sel6.minimum_limit = -19.6
        sel6.maximum_limit =  18.0
        sel7 = Selection()
        sel7.limit_type = "Dec"
        sel7.minimum_limit = -78.0
        sel7.maximum_limit = -19.6
        sel8 = Selection()
        sel8.limit_type = "Dec"
        sel8.minimum_limit = -19.6
        sel8.maximum_limit =  18.0
        sel9 = Selection()
        sel9.limit_type = "Dec"
        sel9.minimum_limit = -78.0
        sel9.maximum_limit = -19.6
