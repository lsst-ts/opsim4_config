...
class WideFastDeepRolling(General):
    def setDefaults(self):
        ...
        sel0 = Selection()
        sel0.limit_type = "Dec"
        sel0.minimum_limit = -78.0
        sel0.maximum_limit = 18.0
        sel1 = Selection()
        sel1.limit_type = "Dec"
        sel1.minimum_limit = -6.9
        sel1.maximum_limit = 18.0
        sel2 = Selection()
        sel2.limit_type = "Dec"
        sel2.minimum_limit = -33.3
        sel2.maximum_limit = -6.9
        sel3 = Selection()
        sel3.limit_type = "Dec"
        sel3.minimum_limit = -78.0
        sel3.maximum_limit = -33.3
        sel4 = Selection()
        sel4.limit_type = "Dec"
        sel4.minimum_limit = -6.9
        sel4.maximum_limit = 18.0
        sel5 = Selection()
        sel5.limit_type = "Dec"
        sel5.minimum_limit = -33.3
        sel5.maximum_limit = -6.9
        sel6 = Selection()
        sel6.limit_type = "Dec"
        sel6.minimum_limit = -78.0
        sel6.maximum_limit = -33.3
        sel7 = Selection()
        sel7.limit_type = "Dec"
        sel7.minimum_limit = -78.0
        sel7.maximum_limit = 18.0
        ...
        time_range1.start = 731
        time_range1.end = 1095
        #m1 3 - 4
        time_range2 = TimeRange()
        time_range2.start = 1096
        time_range2.end = 1460
        #s1 4 - 5
        time_range3 = TimeRange()
        time_range3.start = 1461
        time_range3.end = 1825
        #n2 5 - 6
        time_range4 = TimeRange()
        time_range4.start = 1826
        time_range4.end = 2190
        #m2 6 - 7
        time_range5 = TimeRange()
        time_range5.start = 2191
        time_range5.end = 2555
        #s2 7 - 8
        time_range6 = TimeRange()
        time_range6.start = 2556
        time_range6.end = 2920
        # 8 - 10
        time_range7 = TimeRange()
        time_range7.start = 2921
        time_range7.end = 3650
