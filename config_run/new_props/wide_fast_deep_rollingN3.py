...
__all__ = ["WideFastDeepRollingN3"]
@pexConfig.registerConfig("WideFastDeepRollingN3", general_prop_reg, General)
class WideFastDeepRollingN(General):
    def setDefaults(self):
        self.name = "WideFastDeepN3"
        # -------------------------
        ...
        time_range0.start = 1826
        time_range0.end = 2190
