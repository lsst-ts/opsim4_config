...
__all__ = ["WideFastDeepRollingAll2"]
@pexConfig.registerConfig("WideFastDeepRollingAll2", general_prop_reg, General)
class WideFastDeepRollingAll(General):
    def setDefaults(self):
        self.name = "WideFastDeepA2"
        # -------------------------
